...
.method public removePackage(Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, Lcom/android/server/AttributeCache;->mPackages:Landroid/util/SparseArray;
    ...
    .line 93
    .local v1, pkg:Lcom/android/server/AttributeCache$Package;
    if-eqz v1, :cond_1

    iget-object v3, v1, Lcom/android/server/AttributeCache$Package;->context:Landroid/content/Context;
    ...
    .line 96
    .local v2, ref:Landroid/content/res/Resources;
    if-eqz v2, :cond_0

    .line 97
    iget-object v3, v1, Lcom/android/server/AttributeCache$Package;->context:Landroid/content/Context;

    invoke-virtual {v3, v2}, Landroid/content/Context;->ClearResourcesInActiveResources(Landroid/content/res/Resources;)V
    ...
    invoke-virtual {v3}, Landroid/content/res/AssetManager;->callDestory()V

    .line 104
    .end local v2           #ref:Landroid/content/res/Resources;
    :cond_1
    iget-object v3, p0, Lcom/android/server/AttributeCache;->mPackages:Landroid/util/SparseArray;
    ...
    .line 106
    .end local v1           #pkg:Lcom/android/server/AttributeCache$Package;
    :cond_2
    monitor-exit p0
