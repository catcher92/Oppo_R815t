...
.field private static final EXTERNAL_SD2:Ljava/lang/String; = "/storage/sdcard0/external_sd"
...
.method static synthetic access$100(Lcom/android/server/MountService;Z)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 117
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->unMountAll(Z)I
...
.method static synthetic access$1600(Lcom/android/server/MountService;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1800(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2900(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3200(Lcom/android/server/MountService;)Lcom/android/server/NativeDaemonConnector;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3400(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$4600(Lcom/android/server/MountService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$900(Lcom/android/server/MountService;Z)V
    ...
    .prologue
    .line 117
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->shareUnshareAllVolume(Z)V
...
.method private doSDSwapVolumeUpdate()V
    ...
    const-string v4, "/storage/sdcard0/external_sd"
    ...
    const-string v5, "/storage/sdcard0/external_sd"
...
.method private handleSystemReady()V
    ...
    .line 842
    :cond_4
    const-string v13, "/storage/sdcard0/external_sd"
...
.method private readStorageListLocked()V
    ...
    const-string v12, "oppo dynamic mount,need change /storage/sdcard1 to /storage/sdcard0/external_sd"

    invoke-static {v3, v12}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1899
    const-string v23, "/storage/sdcard0/external_sd"
    ...
    const-string v3, "/storage/sdcard0/external_sd"
...
.method private sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string v2, "/storage/sdcard0/external_sd"
...
.method private shareUnshareAllVolume(Z)V
    .locals 9
    .parameter "enable"
    ...
    const-string v8, "shareUnshareAllVolume "
...
.method private unMountAll(Z)I
    ...
    const-string v9, "will umount path ="
    ...
    invoke-direct {p0, v3, v7, p1}, Lcom/android/server/MountService;->doUnmountVolume(Ljava/lang/String;ZZ)I
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 1364
    .local v21, primaryVolume:Landroid/os/storage/StorageVolume;
    monitor-exit v3
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    .line 1445
    .end local v21           #primaryVolume:Landroid/os/storage/StorageVolume;
    :goto_4
    if-eqz v8, :cond_2
    ...
    .line 1429
    .local v22, secondaryVolume:Landroid/os/storage/StorageVolume;
    monitor-exit v3
    :try_end_5
    ...
    .line 1429
    .end local v22           #secondaryVolume:Landroid/os/storage/StorageVolume;
    :catchall_2
    move-exception v2
...
.method public shareCDRom(Z)V
    ...
    .line 4091
    .local v0, doShare:Z
    new-instance v1, Lcom/android/server/MountService$10;

    invoke-direct {v1, p0, v0}, Lcom/android/server/MountService$10;-><init>(Lcom/android/server/MountService;Z)V

    invoke-virtual {v1}, Lcom/android/server/MountService$10;->start()V
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    iput v14, v0, Lcom/android/server/MountService;->mShutdownCount:I
    ...
    iput-boolean v14, v0, Lcom/android/server/MountService;->mSetDefaultEnable:Z
    ...
    iput-boolean v14, v0, Lcom/android/server/MountService;->mBootCompleted:Z
    ...
    .line 2136
    .local v7, mState:Ljava/lang/String;
    const-string v14, "mounted"
    ...
    iput-boolean v14, v0, Lcom/android/server/MountService;->mShutdownSD:Z
    ...
    invoke-direct {v0, v8, v14, v1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget v14, v0, Lcom/android/server/MountService;->mShutdownCount:I
    ...
    invoke-direct {v13, v0, v8, v1}, Lcom/android/server/MountService$ShutdownCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/IMountShutdownObserver;)V
    ...
    :goto_2
    :try_start_2
    new-instance v14, Lcom/android/server/MountService$8;

    move-object/from16 v0, p0

    invoke-direct {v14, v0}, Lcom/android/server/MountService$8;-><init>(Lcom/android/server/MountService;)V

    invoke-virtual {v14}, Lcom/android/server/MountService$8;->start()V
    ...
    .line 2238
    .end local v7           #mState:Ljava/lang/String;
    :catchall_0
    move-exception v14
    ...
    .restart local v7       #mState:Ljava/lang/String;
...
.method public unmountVolumeNotSwap(Ljava/lang/String;ZZ)V
    ...
    .line 4147
    sget-object v3, Lcom/oppo/os/OppoEnvironment;->SUB_STORAGE_DIRECTORY:Ljava/io/File;
    ...
    .line 4148
    .local v0, childState:Ljava/lang/String;
    const-string v3, "mounted"
    ...
    invoke-direct {p0, v3, p2, p3}, Lcom/android/server/MountService;->doUnmountVolume(Ljava/lang/String;ZZ)I

    .line 4155
    .end local v0           #childState:Ljava/lang/String;
    :cond_2
...
# Remove the first '#' if you want to enable this method. It might be invoked from codes of BOSP.
#.method static synthetic access$iget-mIsUsbConnected-80b301(Lcom/android/server/MountService;)Z
#    .locals 1
#    .parameter "x0"
#    .prologue
