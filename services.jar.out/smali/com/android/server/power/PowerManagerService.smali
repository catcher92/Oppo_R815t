...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/power/PowerManagerService$SmartStayManager;,
...
.field public static final EYE_DECTED_DELAY:I = 0xfa0
...
.field private static final MAX_SMART_STAY_TIME:J = 0x124f80L

.field private static final MINIMUM_SCREEN_OFF_TIMEOUT:I = 0x2710

.field private static final MSG_CALL_USERACTIVITY:I = 0x6
...
.field private static final MSG_START_EYE_DETECTED:I = 0x5
...
# instance fields
.field private bIgnoreProxBecauseScreenTurnedOffDutToUserRequest:Z

.field private bSmartScreenOffSelected:Z

.field private lastUserActivityFromNativeTime:J
...
.field private mIntelligentSleepManager:Lcom/android/server/power/PowerManagerService$SmartStayManager;
...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v0, Lcom/android/server/power/PowerManagerService;->ADBG:Z
...
.method public constructor <init>()V
    ...
    .line 421
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->bSmartScreenOffSelected:Z

    .line 1118
    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/power/PowerManagerService;->lastUserActivityFromNativeTime:J

    .line 1288
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->bIgnoreProxBecauseScreenTurnedOffDutToUserRequest:Z

    .line 1289
    iput v3, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I
    ...
    const-string v2, "StayOnWhilePluggedIn Partial"

    aput-object v2, v1, v3

    const-string v2, "StayOnWhilePluggedIn Screen Dim"

    aput-object v2, v1, v4

    const/4 v2, 0x2

    const-string v3, "android.media.MediaPlayer"
    ...
    const-string v3, "oppo.multimedia.soundrecorder.RecorderService"
    ...
    const-string v3, "StartingObexPbapTransaction"
    ...
    const-string v3, "OppoCsvExportRunnable"
    ...
    const-string v3, "NetworkLocation Check Location"

    aput-object v3, v1, v2

    const/16 v2, 0xd

    const-string v3, "CopyFileWakeLock"
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mAssertUncheck:[Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mAssertCheck:Ljava/lang/Runnable;
...
.method static synthetic access$2200(Lcom/android/server/power/PowerManagerService;JI)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2300(Lcom/android/server/power/PowerManagerService;)Z
    ...
    .prologue
    .line 93
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->bIgnoreProxBecauseScreenTurnedOffDutToUserRequest:Z
...
.method static synthetic access$2500(Lcom/android/server/power/PowerManagerService;JIII)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3700(Lcom/android/server/power/PowerManagerService;)J
    ...
    .prologue
    .line 93
    iget-wide v0, p0, Lcom/android/server/power/PowerManagerService;->lastUserActivityFromNativeTime:J

    return-wide v0
.end method

.method static synthetic access$3800(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$SmartStayManager;
    .locals 1
    .parameter "x0"

    .prologue
    .line 93
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mIntelligentSleepManager:Lcom/android/server/power/PowerManagerService$SmartStayManager;
...
.method static synthetic access$4400(Lcom/android/server/power/PowerManagerService;)Lcom/mediatek/common/tvout/ITVOUTNative;
    .locals 1
    .parameter "x0"
...
.method private goToSleepNoUpdateLocked(JI)Z
    ...
    iput-boolean v9, p0, Lcom/android/server/power/PowerManagerService;->bIgnoreProxBecauseScreenTurnedOffDutToUserRequest:Z
...
.method private updateSettingsLocked()V
    ...
    .line 790
    const-string v3, "oppo_smart_screen_off"
    ...
    :goto_6
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->bSmartScreenOffSelected:Z
    ...
    const-string v6, "updateSettingsLocked: bSmartScreenOffSelected ="

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v6, p0, Lcom/android/server/power/PowerManagerService;->bSmartScreenOffSelected:Z
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    const-string v8, "updateUserActivitySummaryLocked: now = "
...
.method private userActivityFromNative(JII)V
    ...
    .line 1132
    iput-wide p1, p0, Lcom/android/server/power/PowerManagerService;->lastUserActivityFromNativeTime:J
...
.method public bIsScreenOffBecauseOfProximityPositive()Z
    .locals 3
    ...
    const-string v2, "bIsScreenOffBecauseOfProximityPositive: shouldUseProximitySensorLocked :"
    ...
    .line 2240
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mGoToSleepReason:I
...
.method public getLcdBrightness()I
    ...
    .line 2048
    .local v0, currentLcdBrightness:I
    ...
    .line 2050
    iget v1, p0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingMaximum:I
    ...
    .line 2058
    .end local v0           #currentLcdBrightness:I
    :catchall_0
    move-exception v1
...
.method public getOppoBatteryLevel()I
    .locals 1
...
.method public init(Landroid/content/Context;Lcom/android/server/LightsService;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/BatteryService;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/display/DisplayManagerService;)V
    ...
    .line 537
    new-instance v0, Lcom/android/server/power/PowerManagerService$SmartStayManager;

    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1}, Lcom/android/server/power/PowerManagerService$SmartStayManager;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mIntelligentSleepManager:Lcom/android/server/power/PowerManagerService$SmartStayManager;
...
.method public syncProximityPositiveState(Z)V
    .locals 2
    .parameter "positive"

    .prologue
    .line 2063
    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerControllerCallbacks:Lcom/android/server/power/DisplayPowerController$Callbacks;

    invoke-interface {v1}, Lcom/android/server/power/DisplayPowerController$Callbacks;->onProximityPositive()V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/power/DisplayPowerController;->setSyncPendingProximity(Z)V

    .line 2066
    return-void

    .line 2064
    .end local v0           #PROXIMITY_POSITIVE:Z
    :cond_0
    const/4 v0, 0x0
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .line 729
    const-string v0, "oppo_smart_screen_off"
