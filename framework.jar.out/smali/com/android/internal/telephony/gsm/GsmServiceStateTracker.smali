...
.method private revertToNitzTimeZone()V
    ...
    .line 2623
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->setTimeZone()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface/range {v36 .. v36}, Lcom/android/internal/telephony/CommandsInterface;->setCurrentPreferredNetworkType()V
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/internal/telephony/gsm/GSMPhone;->getContext()Landroid/content/Context;
    ...
    const-string v37, "cro_setting"

    const-wide/16 v38, 0x0

    invoke-static/range {v36 .. v39}, Landroid/provider/Settings$System;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    const-string/jumbo v37, "set CRO setting="
    ...
    invoke-virtual/range {v36 .. v38}, Lcom/android/internal/telephony/gsm/GSMPhone;->setCRO(ILandroid/os/Message;)V
    ...
    .line 558
    .local v16, hoo_setting:J
    new-instance v36, Ljava/lang/StringBuilder;

    invoke-direct/range {v36 .. v36}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v37, "set HOO setting="
    ...
    const-string v37, "gprs_transfer_setting"
    ...
    const-string/jumbo v37, "transferType:"
    ...
    .line 589
    const-string v36, "gsm.gcf.testmode"
    ...
    const-string/jumbo v37, "testMode:"
    ...
    .line 598
    const-string/jumbo v36, "persist.radio.gprs.attach.type"
    ...
    .line 591
    .restart local v34       #transferType:I
    :cond_5
    const-string v36, "gsm.gcf.testmode2"
    ...
    const-string v37, "EVENT_GET_LOC_DONE : unknown lac:"
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyLocationChanged()V
    ...
    const-string v38, "error parsing location: "
    ...
    .line 708
    const-string v36, "Start manual selection mode reminder service"
    ...
    .line 710
    .local v29, sIntent:Landroid/content/Intent;
    const-string v36, "com.android.phone"

    const-string v37, "com.mediatek.settings.NoNetworkPopUpService"
    ...
    .end local v29           #sIntent:Landroid/content/Intent;
    :sswitch_8
    move-object/from16 v0, p1
    ...
    invoke-interface/range {v36 .. v37}, Lcom/android/internal/telephony/CommandsInterface;->getSignalStrength(Landroid/os/Message;)V
    ...
    .end local v5           #ar:Landroid/os/AsyncResult;
    :sswitch_c
    const-string v36, "MTK_MVNO_SUPPORT refreshSpnDisplay()"
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubscriberId()Ljava/lang/String;
    ...
    const-string v38, "GSST: Sim1 Card changed  lastImsi is "
    ...
    invoke-virtual/range {v36 .. v36}, Landroid/telephony/ServiceState;->getIsManualSelection()Z
    ...
    const-string v37, "GSST: service state is out of service with manual network selection mode,  setNetworkSelectionModeAutomatic "
    ...
    invoke-virtual/range {v36 .. v37}, Lcom/android/internal/telephony/gsm/GSMPhone;->setNetworkSelectionModeAutomatic(Landroid/os/Message;)V
    ...
    const-string v37, "gsm.sim.imsi.2"
    ...
    .line 780
    .local v27, oldImsi2:Ljava/lang/String;
    if-eqz v27, :cond_10
    ...
    const-string v38, "GSST: Sim2 Card changed  lastImsi is "
    ...
    .end local v27           #oldImsi2:Ljava/lang/String;
    :sswitch_d
    move-object/from16 v0, p1
    ...
    invoke-interface/range {v36 .. v37}, Lcom/android/internal/telephony/CommandsInterface;->getVoiceRegistrationState(Landroid/os/Message;)V
    ...
    invoke-static/range {v36 .. v36}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;)Landroid/os/AsyncResult;
    ...
    .line 829
    .local v33, toggledNetworkType:I
    move-object/from16 v0, p0
    ...
    .line 823
    .end local v21           #message:Landroid/os/Message;
    .end local v33           #toggledNetworkType:I
    :cond_11
    const/16 v36, 0x7
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/internal/telephony/gsm/GSMPhone;->getCellLocation()Landroid/telephony/CellLocation;
    ...
    .end local v20           #loc:Landroid/telephony/gsm/GsmCellLocation;
    :sswitch_12
    const-string v36, "EVENT_RESTRICTED_STATE_CHANGED"
    ...
    .end local v5           #ar:Landroid/os/AsyncResult;
    :sswitch_13
    const-string v36, "GSST EVENT_SET_AUTO_SELECT_NETWORK_DONE"
    ...
    const-string v37, "GSST EVENT_SET_GPRS_CONN_TYPE_DONE"
    ...
    const-string v37, "EVENT_SET_GPRS_CONN_RETRY"
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/internal/telephony/gsm/GSMPhone;->getServiceState()Landroid/telephony/ServiceState;
    ...
    const-string v38, "GSST EVENT_SET_GPRS_CONN_RETRY ServiceState "
    ...
    const-string v38, "GSST EVENT_SET_GPRS_CONN_RETRY airplanMode "
    ...
    .line 885
    .local v13, currentDataConnectionSimId:I
    move-object/from16 v0, p0
    ...
    const-string v37, "gprs_connection_sim_setting"
    ...
    .line 886
    .local v11, currentDataConnectionMultiSimId:J
    const-wide/16 v36, 0x0
    ...
    invoke-static {v0, v11, v12}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I
    ...
    const-string v38, "Default Data Setting value="
    ...
    .end local v11           #currentDataConnectionMultiSimId:J
    .end local v13           #currentDataConnectionSimId:I
    .end local v30           #ss:Landroid/telephony/ServiceState;
    :sswitch_16
    const-string v36, "GSM"

    const-string v37, "EVENT_DATA_CONNECTION_DETACHED: set gprsState=STATE_OUT_OF_SERVICE"
    ...
    invoke-static/range {v38 .. v38}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->networkTypeToString(I)Ljava/lang/String;

    move-result-object v38

    invoke-virtual/range {v36 .. v38}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v37, "gsm.network.type.2"
    ...
    .line 912
    :sswitch_17
    const-string v36, "EVENT_INVALID_SIM_INFO"
    ...
    .end local v5           #ar:Landroid/os/AsyncResult;
    :sswitch_18
    const-string v36, "EVENT_IMEI_LOCK"
    ...
    .line 922
    .restart local v5       #ar:Landroid/os/AsyncResult;
    const-string v36, "EVENT_ENABLE_EMMRRS_STATUS start"
    ...
    const-string v37, "EVENT_ENABLE_EMMRRS_STATUS, data[0] is : "
    ...
    const-string v37, "EVENT_ENABLE_EMMRRS_STATUS, einfo value is : "
    ...
    const-string v37, "EVENT_ENABLE_EMMRRS_STATUS, einfo value change is : "
    ...
    .end local v28           #oldValue:I
    .end local v35           #value:I
    :cond_16
    const-string v36, "EVENT_ENABLE_EMMRRS_STATUS end"
    ...
    .line 938
    .restart local v5       #ar:Landroid/os/AsyncResult;
    const-string v36, "EVENT_DISABLE_EMMRRS_STATUS start"
    ...
    const-string v37, "EVENT_DISABLE_EMMRRS_STATUS, data[0] is : "
    ...
    const-string v37, "EVENT_DISABLE_EMMRRS_STATUS, einfo value is : "
    ...
    .line 944
    .restart local v28       #oldValue:I
    and-int/lit8 v35, v28, 0x7f

    .line 945
    .restart local v35       #value:I
    new-instance v36, Ljava/lang/StringBuilder;

    invoke-direct/range {v36 .. v36}, Ljava/lang/StringBuilder;-><init>()V

    const-string v37, "EVENT_DISABLE_EMMRRS_STATUS, einfo value change is : "
    ...
    .end local v35           #value:I
    :cond_17
    const-string v36, "EVENT_DISABLE_EMMRRS_STATUS end"
...
.method setTimeZone()V
    ...
    .line 3418
    const-string/jumbo v6, "telephony.test.ignore.nitz"
    ...
    .line 3421
    .local v1, testOneUniqueOffsetPath:Z
    :goto_0
    const/4 v0, 0x0
    ...
    .line 3429
    .local v2, uniqueZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    ...
    const-string/jumbo v5, "setTimeZone: no nitz but one TZ for iso-cc="
    ...
    const-string v5, " with zone.getID="
    ...
    const-string v5, " testOneUniqueOffsetPath="
    ...
    .end local v1           #testOneUniqueOffsetPath:Z
    .end local v2           #uniqueZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    .end local v3           #zone:Ljava/util/TimeZone;
    :cond_1
    move v1, v5
    ...
    .restart local v1       #testOneUniqueOffsetPath:Z
    .restart local v3       #zone:Ljava/util/TimeZone;
    :cond_2
    const-string v6, "gsm.operator.iso-country.2"
    ...
    .line 3439
    .restart local v2       #uniqueZones:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/util/TimeZone;>;"
    :cond_3
    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "setTimeZone: there are "
    ...
    const-string v5, " unique offsets for iso-cc=\'"
...
.method protected updateSpnDisplay(Z)V
    ...
    .line 3244
    const-string/jumbo v14, "send broadcast Intents.SPN_STRINGS_UPDATED_ACTION"
