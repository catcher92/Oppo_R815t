...
CUSTOM_HAL_IMGSENSOR = ov5647_mipi_raw hi253_yuv
...
CUSTOM_KERNEL_ACCELEROMETER = adxl346 lis3dh
CUSTOM_KERNEL_ALSPS = stk31xx tmd2771
CUSTOM_KERNEL_BATTERY = battery
...
CUSTOM_KERNEL_IMGSENSOR = ov5647_mipi_raw hi253_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = ht_wvga_13009
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = R815T_11_C.02_140425
MTK_BWC_SUPPORT = yes
...
MTK_RCSE_SUPPORT = no
MTK_RELEASE_PACKAGE = rel_customer_operator_cmcc rel_customer_advanced_mt6589
...
OPPO_DISABLE_SMALL_WINDOW_LEATHER = yes
OPPO_DISABLE_SMART_SWITCH_SUPPORT = no
OPPO_DM_TEST = no
OPPO_DOLBY_SUPPORT = yes
OPPO_DOUBLECLICK_PRECAMERA_SUPPORT = no
OPPO_DOUBLE_FLINGER_VOLUME_SUPPORT = yes
OPPO_EMMC_DYNAMICMOUNT_SUPPORT = yes
OPPO_ENTRANCEGUARD_ENABLE = no
OPPO_EXTERNAL_STORAGE_SUPPORT = yes
OPPO_FILTRATED_APP = yes
...
OPPO_SMART_SLEEP_SUPPORT = no
OPPO_SOUNDEFFECT_SUPPORT = no
OPPO_SW_SOLUTION_DEVICE = yes
OPPO_SW_SOLUTION_ROM = no
