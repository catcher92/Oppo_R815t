...
.method private constructor <init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    .line 1527
    iput-boolean v5, p0, Landroid/widget/RemoteViews;->mHasUsedCustomerView:Z
    ...
    iput-object v5, p0, Landroid/widget/RemoteViews;->mActions:Ljava/util/ArrayList;
    ...
    .line 1529
    .restart local v1       #customer:I
    :cond_1
    iput-boolean v6, p0, Landroid/widget/RemoteViews;->mHasUsedCustomerView:Z
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetOnClickPendingIntent;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetOnClickPendingIntent;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetDrawableParameters;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetDrawableParameters;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$ReflectionAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$ViewGroupAction;

    iget-object v7, p0, Landroid/widget/RemoteViews;->mBitmapCache:Landroid/widget/RemoteViews$BitmapCache;

    invoke-direct {v6, p0, p1, v7}, Landroid/widget/RemoteViews$ViewGroupAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$ReflectionActionWithoutParams;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$ReflectionActionWithoutParams;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetEmptyView;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetEmptyView;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetPendingIntentTemplate;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetPendingIntentTemplate;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetOnClickFillInIntent;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetOnClickFillInIntent;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$SetRemoteViewsAdapterIntent;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$SetRemoteViewsAdapterIntent;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$TextViewDrawableAction;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$TextViewDrawableAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$TextViewSizeAction;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$TextViewSizeAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$ViewPaddingAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    new-instance v6, Landroid/widget/RemoteViews$BitmapReflectionAction;

    invoke-direct {v6, p0, p1}, Landroid/widget/RemoteViews$BitmapReflectionAction;-><init>(Landroid/widget/RemoteViews;Landroid/os/Parcel;)V
    ...
    invoke-direct {v5, p1, v6}, Landroid/widget/RemoteViews;-><init>(Landroid/os/Parcel;Landroid/widget/RemoteViews$BitmapCache;)V

    iput-object v5, p0, Landroid/widget/RemoteViews;->mLandscape:Landroid/widget/RemoteViews;
    ...
    iput-object v5, p0, Landroid/widget/RemoteViews;->mPortrait:Landroid/widget/RemoteViews;
    ...
    .line 1594
    :cond_4
    new-instance v5, Landroid/widget/RemoteViews$MemoryUsageCounter;

    invoke-direct {v5, p0, v8}, Landroid/widget/RemoteViews$MemoryUsageCounter;-><init>(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews$1;)V

    iput-object v5, p0, Landroid/widget/RemoteViews;->mMemoryUsageCounter:Landroid/widget/RemoteViews$MemoryUsageCounter;
...
.method public apply(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/widget/RemoteViews$OnClickHandler;)Landroid/view/View;
    ...
    .line 2281
    iget-boolean v4, p0, Landroid/widget/RemoteViews;->mHasUsedCustomerView:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 2405
    .local v0, a:Landroid/widget/RemoteViews$Action;
    invoke-virtual {v0, p1, v5}, Landroid/widget/RemoteViews$Action;->writeToParcel(Landroid/os/Parcel;I)V
