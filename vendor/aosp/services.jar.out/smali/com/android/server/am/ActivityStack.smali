...
.field private originalIntentFlag:I
...
.field private sourceRecordTemp:Lcom/android/server/am/ActivityRecord;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 293
    iput-object v4, p0, Lcom/android/server/am/ActivityStack;->sourceRecordTemp:Lcom/android/server/am/ActivityRecord;

    .line 294
    iput v3, p0, Lcom/android/server/am/ActivityStack;->originalIntentFlag:I

    .line 295
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStack;->bRecordUsed:Z
...
.method final activityIdleInternal(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    sget-object v2, Lcom/android/server/am/ActivityManagerService;->mIPOWin:Landroid/view/View;
    ...
    const-string v3, "com.oppo.alarmclock.alarmclock.AlarmAlertFullScreen"
...
.method checkReadyForSleepLocked()V
    ...
    sget-object v2, Lcom/android/server/am/ActivityManagerService;->skipList:Ljava/util/List;
    ...
    const-string v4, "DEBUG INFO : SKIP SLEEP "
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-static {v2}, Landroid/oppoutils/OppoUtils;->cpuBoost(I)V
    ...
    const-string v3, "(test)resumeTopActivityLocked: change to homeMode"
    ...
    const-string v2, "Intent.ACTION_HOME_MODE_CHANGE"
    ...
    const-string v3, "(test)resumeTopActivityLocked:  statusbar change to notHomeMode"
    ...
    const-string v3, "(test)resumeTopActivityLocked:prev is null change to homeMode"
    ...
    .line 1826
    .restart local v24       #numOfActivity:I
    ...
    const-string v4, "Update finishing activity visibility "
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-static {v3}, Landroid/oppoutils/OppoUtils;->cpuBoost(I)V
    ...
    const-string v6, "Will send result to "
    ...
    const-string v6, "startActivityLocked, return, requestCode: "
    ...
    const-string v6, "startActivityLocked, return, err: "
    ...
    const-string v4, "startActivityLocked,return, mController abort."
