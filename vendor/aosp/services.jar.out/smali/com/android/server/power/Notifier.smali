...
.field private final mOppoScreenOffIntent:Landroid/content/Intent;

.field private final mOppoScreenOnIntent:Landroid/content/Intent;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/server/power/SuspendBlocker;Lcom/android/server/power/ScreenOnBlocker;Landroid/view/WindowManagerPolicy;)V
    ...
    const-string v1, "com.oppo.SCREEN_ON"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/power/Notifier;->mOppoScreenOnIntent:Landroid/content/Intent;

    .line 135
    new-instance v0, Landroid/content/Intent;

    const-string v1, "com.oppo.SCREEN_OFF"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/power/Notifier;->mOppoScreenOffIntent:Landroid/content/Intent;
...
.method private sendGoToSleepBroadcast(I)V
    ...
    iget-object v1, p0, Lcom/android/server/power/Notifier;->mOppoScreenOffIntent:Landroid/content/Intent;
...
.method private sendWakeUpBroadcast()V
    ...
    iget-object v1, p0, Lcom/android/server/power/Notifier;->mOppoScreenOnIntent:Landroid/content/Intent;
