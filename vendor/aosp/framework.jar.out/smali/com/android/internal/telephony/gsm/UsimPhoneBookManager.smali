...
.method static synthetic access$600(Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;)Lcom/android/internal/telephony/IccFileHandler;
    .locals 1
    .parameter "x0"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 994
    .local v6, adns:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/AdnRecord;>;"
    move-object/from16 v0, p0
    ...
    check-cast v35, Lcom/android/internal/telephony/AdnRecord;

    .line 1005
    .local v35, theAdn:Lcom/android/internal/telephony/AdnRecord;
    invoke-virtual/range {v35 .. v35}, Lcom/android/internal/telephony/AdnRecord;->getRecordIndex()I
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/AdnRecord;->setRecordIndex(I)V

    goto :goto_2

    .line 1008
    .end local v15           #i$:Ljava/util/Iterator;
    .end local v27           #recBase:I
    .end local v35           #theAdn:Lcom/android/internal/telephony/AdnRecord;
    :cond_3
    if-eqz v6, :cond_4
    ...
    .line 1017
    .end local v6           #adns:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/AdnRecord;>;"
    :goto_3
    move-object/from16 v0, p0
    ...
    const-string v39, "Loading USIM ANR records size done mAnrFileSize:"
    ...
    const-string v39, ", mAnrRecordSize:"
    ...
    const-string v39, "Loading USIM ANR records done "
    ...
    .line 1055
    const-string/jumbo v38, "mAnrFileList is null !!!! recreat it !"
    ...
    .line 1079
    .local v17, iccException:Lcom/android/internal/telephony/IccException;
    if-nez v17, :cond_a
    ...
    .line 1091
    .end local v17           #iccException:Lcom/android/internal/telephony/IccException;
    :cond_a
    move-object/from16 v0, p0
    ...
    .line 1135
    const-string/jumbo v38, "mEmailFileList is null !!!! recreat it !"
    ...
    const-string/jumbo v40, "recordSize="
    ...
    .line 1171
    .local v10, em:Lcom/android/internal/telephony/IccIoResult;
    new-instance v38, Ljava/lang/StringBuilder;
    ...
    .line 1173
    invoke-virtual {v10}, Lcom/android/internal/telephony/IccIoResult;->getException()Lcom/android/internal/telephony/IccException;

    move-result-object v17

    .line 1175
    .restart local v17       #iccException:Lcom/android/internal/telephony/IccException;
    if-nez v17, :cond_12
    ...
    iget-object v0, v10, Lcom/android/internal/telephony/IccIoResult;->payload:[B
    ...
    .line 1195
    .end local v7           #ar:Landroid/os/AsyncResult;
    .end local v10           #em:Lcom/android/internal/telephony/IccIoResult;
    :sswitch_9
    ...
    invoke-direct {v0, v1, v2, v13}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->updatePhoneAdnRecordWithGrpByIndex(II[I)V

    .line 1233
    .end local v13           #grpIds:[I
    .end local v14           #i:I
    :cond_15
    move-object/from16 v0, p0
    ...
    .line 1261
    .local v12, gasList:[Ljava/lang/String;
    if-eqz v12, :cond_18
    ...
    .line 1266
    .local v11, gas:Ljava/lang/String;
    new-instance v36, Lcom/android/internal/telephony/UsimGroup;
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/internal/telephony/UsimGroup;-><init>(ILjava/lang/String;)V

    .line 1267
    .local v36, uGasEntry:Lcom/android/internal/telephony/UsimGroup;
    move-object/from16 v0, p0
    ...
    .line 1272
    .end local v11           #gas:Ljava/lang/String;
    .end local v12           #gasList:[Ljava/lang/String;
    .end local v14           #i:I
    .end local v36           #uGasEntry:Lcom/android/internal/telephony/UsimGroup;
    :cond_18
    move-object/from16 v0, p0
    ...
    .end local v7           #ar:Landroid/os/AsyncResult;
    :sswitch_f
    const-string/jumbo v38, "update UPB GAS done"
    ...
    const-string/jumbo v39, "update UPB GAS done mResult is "
    ...
    :sswitch_10
    const-string/jumbo v38, "update UPB GRP done"
    ...
    const-string/jumbo v40, "unsupported tag when loading record size "
    ...
    check-cast v25, Lcom/android/internal/telephony/IccIoResult;

    .line 1427
    .local v25, r:Lcom/android/internal/telephony/IccIoResult;
    if-eqz v25, :cond_28

    .line 1428
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/IccIoResult;->getException()Lcom/android/internal/telephony/IccException;
    ...
    .line 1450
    .end local v7           #ar:Landroid/os/AsyncResult;
    .end local v25           #r:Lcom/android/internal/telephony/IccIoResult;
    :sswitch_17
    move-object/from16 v0, p1
    ...
    .line 1454
    .local v19, list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    iget-object v0, v7, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .end local v19           #list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    check-cast v19, Ljava/util/ArrayList;

    .line 1456
    .restart local v19       #list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    iget-object v0, v7, Landroid/os/AsyncResult;->userObj:Ljava/lang/Object;
    ...
    .line 1460
    const-string/jumbo v38, "mSneFileList is null !!!! recreat it !"
    ...
    .end local v8           #e:Ljava/lang/IndexOutOfBoundsException;
    .end local v19           #list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    .end local v33           #snePbr:I
    :sswitch_18
    const-string/jumbo v38, "update UPB SNE done"
    ...
    invoke-static/range {v38 .. v40}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    check-cast v26, Lcom/android/internal/telephony/IccIoResult;

    .line 1489
    .local v26, re:Lcom/android/internal/telephony/IccIoResult;
    new-instance v38, Ljava/lang/StringBuilder;
    ...
    .line 1497
    .local v16, iapList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    const/16 v38, 0x1
    ...
    .line 1501
    .end local v16           #iapList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<[B>;"
    .end local v17           #iccException:Lcom/android/internal/telephony/IccException;
    :cond_2d
    move-object/from16 v0, p0
...
.method public oppoUpdateAdn(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;ILjava/lang/String;Landroid/os/Message;)I
    ...
    .local v11, it:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/AdnRecord;>;"
    :goto_1
    ...
    .line 3947
    .end local v11           #it:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/AdnRecord;>;"
    :cond_4
    const/4 v13, 0x0
