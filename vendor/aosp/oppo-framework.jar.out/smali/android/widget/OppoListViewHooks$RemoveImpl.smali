...
.method private adjustViewsUpOrDown()V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getChildCount()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->isStackFromBottom()Z
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getChildAt(I)Landroid/view/View;
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListPaddingTop()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getFirstVisiblePosition()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getDividerHeight()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->offsetChildrenTopAndBottom(I)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getHeight()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListPaddingBottom()I
...
.method private correctTooHigh(I)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getBottom()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getTop()I
...
.method private fillDown(II)Landroid/view/View;
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListBottom()I
    ...
    .line 368
    invoke-virtual {v3}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;->getView()Landroid/view/View;
    ...
    #calls: Landroid/widget/OppoListViewHooks;->setVisibleRangeHint(II)V
...
.method private fillUp(II)Landroid/view/View;
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListTop()I
    ...
    .line 388
    invoke-virtual {v4}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;->getView()Landroid/view/View;

    move-result-object v3

    .line 390
    :cond_0
    invoke-virtual {v4}, Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveItem;->getPos()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->setFirstVisiblePosition(I)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getLastVisiblePosition()I
...
.method private getAndAddView(IIZ)Landroid/widget/OppoListViewHooks$RemoveImpl$RemoveView;
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getSelectedPosition()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListPaddingLeft()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getIsScrap()[Z
    ...
    #calls: Landroid/widget/OppoListViewHooks;->setupChild(Landroid/view/View;IIZIZZ)V
...
.method private resetDown(III)V
    .locals 9
    .parameter "count"
    .parameter "pos"
    .parameter "nextTop"
    ...
    .line 587
    iget-object v0, p0, Landroid/widget/OppoListViewHooks$RemoveImpl;->this$0:Landroid/widget/OppoListViewHooks;

    #calls: Landroid/widget/OppoListViewHooks;->getListBottom()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$800(Landroid/widget/OppoListViewHooks;)I

    move-result v8

    .line 589
    .local v8, end:I
    const-string v0, "OppoListViewHooks.RemoveImpl"

    const-string v1, "***** resetDown : makeAndAddView"
    ...
    invoke-virtual {v0}, Landroid/widget/OppoListViewHooks;->getCount()I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getSelectedPosition()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$300(Landroid/widget/OppoListViewHooks;)I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListPaddingLeft()I
    invoke-static {v1}, Landroid/widget/OppoListViewHooks;->access$1800(Landroid/widget/OppoListViewHooks;)I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->makeAndAddView(IIZIZ)Landroid/view/View;
    invoke-static/range {v0 .. v5}, Landroid/widget/OppoListViewHooks;->access$2100(Landroid/widget/OppoListViewHooks;IIZIZ)Landroid/view/View;

    move-result-object v7

    .line 595
    .local v7, child:Landroid/view/View;
    invoke-direct {p0, v7, p2}, Landroid/widget/OppoListViewHooks$RemoveImpl;->addRemoveItem(Landroid/view/View;I)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getDividerHeight()I
    invoke-static {v1}, Landroid/widget/OppoListViewHooks;->access$600(Landroid/widget/OppoListViewHooks;)I
    ...
    const-string v1, "***** resetDown : obtainView only"
    ...
    .line 604
    invoke-direct {p0, p2}, Landroid/widget/OppoListViewHooks$RemoveImpl;->isBelowRemoved(I)Z
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getIsScrap()[Z
    invoke-static {v1}, Landroid/widget/OppoListViewHooks;->access$1900(Landroid/widget/OppoListViewHooks;)[Z

    move-result-object v1

    #calls: Landroid/widget/OppoListViewHooks;->obtainView(I[Z)Landroid/view/View;
    invoke-static {v0, p2, v1}, Landroid/widget/OppoListViewHooks;->access$2200(Landroid/widget/OppoListViewHooks;I[Z)Landroid/view/View;

    move-result-object v0

    invoke-direct {p0, v0, p2}, Landroid/widget/OppoListViewHooks$RemoveImpl;->addRemoveItem(Landroid/view/View;I)V
    ...
    const-string v1, "***** resetDown : done"
...
.method private resetUp(III)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getListTop()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$1000(Landroid/widget/OppoListViewHooks;)I
    ...
    const-string v1, "***** resetUp : makeAndAddView"

    invoke-static {v9, v0, v1}, Lcom/oppo/util/OppoLog;->e(ZLjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "***** resetUp : obtainView only"
    ...
    .line 632
    invoke-direct {p0, p2}, Landroid/widget/OppoListViewHooks$RemoveImpl;->isAboveRemoved(I)Z
...
.method private setupCache()V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getChildAt(I)Landroid/view/View;
    invoke-static {v0, v5}, Landroid/widget/OppoListViewHooks;->access$1100(Landroid/widget/OppoListViewHooks;I)Landroid/view/View;

    move-result-object v7

    .line 644
    .local v7, oldFirst:Landroid/view/View;
    if-nez v7, :cond_1

    iget-object v0, p0, Landroid/widget/OppoListViewHooks$RemoveImpl;->this$0:Landroid/widget/OppoListViewHooks;

    #calls: Landroid/widget/OppoListViewHooks;->getListPaddingTop()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$1200(Landroid/widget/OppoListViewHooks;)I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getFirstVisiblePosition()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$000(Landroid/widget/OppoListViewHooks;)I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getChildCount()I
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$700(Landroid/widget/OppoListViewHooks;)I
    ...
    #calls: Landroid/widget/OppoListViewHooks;->detachAllViewsFromParent()V
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$2300(Landroid/widget/OppoListViewHooks;)V
    ...
    invoke-direct {p0, v9, v1}, Landroid/widget/OppoListViewHooks$RemoveImpl;->addRemoveItem(Landroid/view/View;I)V

    .line 655
    iget-object v0, p0, Landroid/widget/OppoListViewHooks$RemoveImpl;->this$0:Landroid/widget/OppoListViewHooks;

    #calls: Landroid/widget/OppoListViewHooks;->isStackFromBottom()Z
    invoke-static {v0}, Landroid/widget/OppoListViewHooks;->access$500(Landroid/widget/OppoListViewHooks;)Z
    ...
    invoke-direct {p0, v6, v0, v4}, Landroid/widget/OppoListViewHooks$RemoveImpl;->resetUp(III)V
    ...
    invoke-direct {p0, v6, v0, v4}, Landroid/widget/OppoListViewHooks$RemoveImpl;->resetDown(III)V

    .line 663
    :goto_1
    invoke-direct {p0}, Landroid/widget/OppoListViewHooks$RemoveImpl;->sortRemoveCache()V
    ...
    const-string v10, "setupCache : mFirstPosition="
    ...
    invoke-static {v3, v0, v4}, Lcom/oppo/util/OppoLog;->e(ZLjava/lang/String;Ljava/lang/String;)V
...
.method public setRemovedItems(Ljava/util/List;)V
    ...
    #calls: Landroid/widget/OppoListViewHooks;->getHeaderViewsCount()I
    ...
    .end local v2           #pos:I
    :cond_2
    invoke-direct {p0}, Landroid/widget/OppoListViewHooks$RemoveImpl;->setupCache()V
